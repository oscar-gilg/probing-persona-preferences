...
\item \textbf{The direction generalises across token positions.} It discriminates evaluative content from the final prompt token through task-averaged activations to the turn-boundary token (Cohen's $d \approx 2$--$3$), strongest at the turn boundary.
...
\begin{itemize}
\item \textbf{Backbone:} Gemma-3-27B-instruct, residual stream, final prompt token.
