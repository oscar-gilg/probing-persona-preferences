#!/bin/bash
# Run extraction for the final-six sweep-recommended personas on the canonical
# 6000-task set. Output lands at /workspace/activations/gemma-3-27b_it/pref_<persona>_sweep/
...
# Must match experiments/persona_sweep/sweep_personas.json :: metadata.final_six
