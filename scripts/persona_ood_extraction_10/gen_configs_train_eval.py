"""Generate 10 persona extraction configs for the train+eval splits.

Writes configs/extraction/pref_<persona>_train_eval.yaml pointing at
data/canonical_splits/train_eval_task_ids.txt (5000 tasks) and output_dir
...
def main() -> None:
    ...
    for persona in PERSONAS:
        cfg = {
            ...
            "temperature": 1.0,
            "seed": 42,
            "output_dir": f"/workspace/activations/gemma-3-27b_it/pref_{persona}_train_eval",
            "system_prompt": prompts[persona],
        }
        out = CONFIG_DIR / f"pref_{persona}_train_eval.yaml"
