"""Verify one persona's train_eval extraction outputs against spec success criteria.

Usage: python scripts/persona_ood_extraction_10/verify_extraction_train_eval.py <persona>
...
MIN_TASK_IDS = 4950  # spec: ≥ 4950 out of 5000
...
def main() -> None:
    persona = sys.argv[1]
    out_dir = Path(f"/workspace/activations/gemma-3-27b_it/pref_{persona}_train_eval")
    failures: list[str] = []
