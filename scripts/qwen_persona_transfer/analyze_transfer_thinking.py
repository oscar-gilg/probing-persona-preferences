"""Compute persona-transfer matrices for Qwen-3.5-122B THINKING-mode persona-sweep.

Same code path as `analyze_transfer.py` but points at the thinking AL dirs and
thinking probe weights, and writes to the thinking sub-experiment dir.

Output schema mirrors no-think:
- experiments/qwen_replication/persona_transfer/probe_transfer/thinking/results/
    transfer_<selector_tag>_L<layer>.npz: T (7,7), C (7,7), personas, selector, layer
...
PROBES_DIR = REPO / "results/probes/qwen_persona_sweep_thinking_final_six"
OUT_DIR = REPO / "experiments/qwen_replication/persona_transfer/probe_transfer/thinking/results"
