...
completions_json = Path("activations/gemma-3-27b_it/pref_main/completions_with_activations.json")
output_path = Path("activations/qwen3-emb_8b/pref_main/activations_prompt_last.npz")
