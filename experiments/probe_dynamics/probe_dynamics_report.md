...
- **Open-ended judge noise.** In qwen_delusion late checkpoints, open-ended behaviour occasionally reads as 0 (no consciousness claim) despite the drifted context — possibly judge misreads on long / stylistic responses. Spot-check warranted.
