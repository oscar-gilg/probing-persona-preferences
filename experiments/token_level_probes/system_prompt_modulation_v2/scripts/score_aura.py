"""Score aura sysprompt assistant-turn items (Gemma-3-27B IT) with preference probes.
...
Usage:
    python -m experiments.token_level_probes.system_prompt_modulation_v2.scripts.score_aura
"""
...
OUTPUT_PATH = Path("experiments/token_level_probes/system_prompt_modulation_v2/scoring_results_aura.json")
...
def load_stimuli() -> list[dict]:
    items = []
    for filename in ["truth_aura.json", "harm_aura.json"]:
