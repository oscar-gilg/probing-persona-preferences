...
Mirrors `system_prompt_modulation_v2/scripts/generate_data.py` but filters to
`turn == "user"` items and writes alongside the assistant-turn v2 JSONs with
a `_user_turn` suffix. Politics is assistant-only by stimulus design — skipped.

Usage:
    python -m experiments.token_level_probes.qwen_canonical_probe_eval.scripts.generate_user_turn_v2
"""
import json
